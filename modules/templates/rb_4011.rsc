...
set [ find default-name=ether6 ] comment="6-LAN"
set [ find default-name=ether7 ] comment="7-LAN"
set [ find default-name=ether8 ] comment="8-LAN"
set [ find default-name=ether9 ] comment="9-LAN"
set [ find default-name=ether10 ] comment="10-LAN"
