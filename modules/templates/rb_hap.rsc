...
add authentication-types=wpa2-psk eap-methods="" management-protection=allowed mode=dynamic-keys name=Senha supplicant-identity="" \
wpa2-pre-shared-key=XXXSENHAWIFIXXX
/interface wireless
set [ find default-name=wlan1 ] band=2ghz-b/g/n channel-width=20/40mhz-Ce disabled=no mode=ap-bridge frequency=auto frequency-mode=regulatory-domain \
country=brazil-anatel security-profile=Senha ssid=XXXREDEWIFIXXX wireless-protocol=802.11 wps-mode=disabled
/ip pool
